    ...
    <>
      ...
      <section className="About-section jos" id="about">
        ...
        <p className="section-sub-text about-sub-text zoom_in">
          Hi, my name is <span>Sachin </span> and I began using WordPress
        ...
        <div className="about-detail-main">
          ...
          <p className="about-detail-info">Sachin</p>
        </div>
        <div className="about-detail-main">
        ...
        <div className="about-detail-main">
          ...
          <p
            ...
            onClick="location.href='tel:(+91)9569665709'"
          >
            (+91) 9569665709
          </p>
        </div>
        <div className="about-detail-main">
          ...
          <p
            className="about-detail-info email"
            onClick="location.href='mailto:sachinrajpoot1253@gmail.com'"
          >
            sachinrajpoot1253@gmail.com
          </p>
        </div>
        ...
        <div className="about-detail-main">
          ...
          <p className="about-detail-info">Hindi</p>
        </div>
      </section>
      {/* <!-- ====================================== Section About End ===================================== --> */}
    </>
